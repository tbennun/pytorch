...
static PyObject * python_enter_dual_level(PyObject* _unused, PyObject* arg) {
  HANDLE_TH_ERRORS
  // It is unlikely that the depth of forward model will overflow int64_t so we
...
static PyMethodDef methods[] = { // NOLINT
  ...
  {"make_dual", (PyCFunction)(void(*)(void))python_make_dual, METH_VARARGS | METH_KEYWORDS, nullptr},
  {"unpack_dual", (PyCFunction)(void(*)(void))python_unpack_dual, METH_VARARGS | METH_KEYWORDS, nullptr},
  {"enter_dual_level", (PyCFunction)python_enter_dual_level, METH_NOARGS, nullptr},
  {"exit_dual_level", (PyCFunction)(void(*)(void))python_exit_dual_level, METH_VARARGS | METH_KEYWORDS, nullptr},
